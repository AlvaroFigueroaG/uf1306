...
function validarFormulario() {
    ...
    if (tfno.value == "") {
        // Si está vacío se mostrará el mensaje “El campo ‘Teléfono’ es obligatorio”
        alert("El campo 'Teléfono' es obligatorio");
        // y se pondrá el foco en el campo “Teléfono”
        tfno.focus();
        valido = false;
    }
    //  Validar con JavaScript que la dirección de email es válida
        ...
        // Si no es válido mostrará el mensaje de error
        alert("El número de teléfono no parece válido. Introduce sólo caracteres numéricos.");
        // y se pondrá el foco en el campo “tfno”
        tfno.focus();
        valido = false;
    }
